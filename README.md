WPF-приложение для управления личными финансами с системой аутентификации пользователей и ролевой моделью доступа.
...
## Тестирование
Приложение включает проверки:

- Валидация паролей (длина, символы, цифры)
